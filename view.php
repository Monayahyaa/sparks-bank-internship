...
<div class="container pt-5 ">
    ...
    <h1 class="text-center pb-4">Customers List</h1>
        ...
        <button class="btn btn-danger w-25 rounded-end">Search</button>
    </form>
    <div class="table">
        ...
        <div class="t-row row">
            ...
            <div class="head   col-md-1"><div><a href="viewone.php?id=<?=$row['id'];?>" class="btn btn-danger">View</a></div></div>
        </div>
        <?php endforeach;?>
    </div>
